...
<section class="formStyle" id="formStyle">
    ...
    <form action="/editemployee2" method="post" class="divForm">
        @csrf
        @if (isset($id))
        <input style="display: none"  value="{{$id}}"  name="id" type="text" id="default-input" class="idStyle bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
...
<div>
    ...
    <select class="selectOut" name="scheduleTimeout" id="">
        ...
        <div class="alert p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
         <span class="font-medium">Error!!</span> Email existent.
       </div>
